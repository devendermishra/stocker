...
use crate::portfolio::{AllocationTable, AuthGuard, SummaryCard, return_pct_label};
use crate::portfolio_api::{fmt_inr, fmt_pct, fmt_return_pct, txn_type_label};
use crate::routes::Route;
use crate::sync_portfolio::layout::{SyncPortfolioBanner, SyncPortfolioNav, SyncPortfolioTab};
use crate::sync_portfolio_api::{remote_dashboard, sync_remote_exported_at};

#[component]
pub fn SyncPortfolioOverview(id: i64) -> Element {
    ...
    rsx! {
        AuthGuard {
            ...
            SyncPortfolioNav { id, active: SyncPortfolioTab::Overview }
            match &*dash.read_unchecked() {
                ...
                Some(Ok(d)) => rsx! {
                    ...
                    Link {
                        to: Route::SyncPortfolioTransactions { id },
                        style: "color: #184ad8; font-size: 0.9rem;",
