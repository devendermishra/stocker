...
pub const CATALOG: &[MetricSpec] = &[
    ...
    MetricSpec { id: MetricId::EnterpriseValue, label: "Enterprise Value", description: "Yahoo EV when present, else market cap + debt − Yahoo totalCash (not statement liquid investments).", category: MetricCategory::MarketStructure, unit: Unit::RupeesCr, source_kind: SourceKind::Live, column: "enterprise_value", needs_review: false },
    ...
    MetricSpec { id: MetricId::PriceToFcf, label: "P / 3Y avg FCF", description: "Price / 3-year average statement FCF (CFO − capex) per share; not Yahoo levered FCF.", category: MetricCategory::Valuation, unit: Unit::Multiple, source_kind: SourceKind::Composite, column: "price_to_fcf", needs_review: false },
    ...
    MetricSpec { id: MetricId::EvToEbitda, label: "EV/EBITDA", description: "Yahoo enterpriseToEbitda when present, else (mcap + debt − Yahoo totalCash) / EBITDA.", category: MetricCategory::Valuation, unit: Unit::Multiple, source_kind: SourceKind::Live, column: "ev_to_ebitda", needs_review: false },
    ...
    MetricSpec { id: MetricId::PegRatio, label: "PEG Ratio", description: "PE / 3Y statement PAT CAGR. Missing when the CAGR is excluded (scope mix) or not positive. Does not use Yahoo earningsGrowth/revenueGrowth.", category: MetricCategory::Valuation, unit: Unit::Multiple, source_kind: SourceKind::Composite, column: "peg_ratio", needs_review: false },
    MetricSpec { id: MetricId::EarningsYieldPct, label: "Earnings yield (EBIT/EV)", description: "Greenblatt-style earnings yield (Trailing EBIT / Enterprise Value).", category: MetricCategory::Valuation, unit: Unit::Percent, source_kind: SourceKind::Composite, column: "earnings_yield_pct", needs_review: false },
    ...
    MetricSpec { id: MetricId::SalesGrowth3yCagrPct, label: "Sales growth 3Y CAGR", description: "Compounded sales growth over a consistent annual-statement suffix. Excluded if years mix standalone/consolidated or latest FY does not align with Yahoo TTM.", category: MetricCategory::IncomeMargins, unit: Unit::Percent, source_kind: SourceKind::Composite, column: "sales_growth_3y_cagr_pct", needs_review: false },
    MetricSpec { id: MetricId::SalesGrowth5yCagrPct, label: "Sales growth 5Y CAGR", description: "Compounded sales growth over a consistent annual suffix (falls back to 4Y/3Y if Yahoo has fewer years). Same scope/TTM checks as 3Y CAGR.", category: MetricCategory::IncomeMargins, unit: Unit::Percent, source_kind: SourceKind::Composite, column: "sales_growth_5y_cagr_pct", needs_review: false },
    MetricSpec { id: MetricId::SalesGrowth7yCagrPct, label: "Sales growth 7Y CAGR", description: "Compounded sales growth over a consistent annual suffix (falls back to shorter spans). Same scope/TTM checks as 3Y CAGR.", category: MetricCategory::IncomeMargins, unit: Unit::Percent, source_kind: SourceKind::Composite, column: "sales_growth_7y_cagr_pct", needs_review: false },
    ...
    MetricSpec { id: MetricId::ProfitGrowth3yCagrPct, label: "Profit growth 3Y CAGR", description: "Compounded PAT over a consistent annual-statement suffix. Not Yahoo earningsGrowth (that is a different period).", category: MetricCategory::IncomeMargins, unit: Unit::Percent, source_kind: SourceKind::Composite, column: "profit_growth_3y_cagr_pct", needs_review: false },
    MetricSpec { id: MetricId::ProfitGrowth5yCagrPct, label: "Profit growth 5Y CAGR", description: "Compounded PAT over a consistent annual suffix. Not Yahoo earningsGrowth.", category: MetricCategory::IncomeMargins, unit: Unit::Percent, source_kind: SourceKind::Composite, column: "profit_growth_5y_cagr_pct", needs_review: false },
    ...
    MetricSpec { id: MetricId::FreeCashflowLastYear, label: "Free cash flow last year", description: "Latest annual FCF as CFO − capex (not Yahoo levered freeCashflow).", category: MetricCategory::CashFlow, unit: Unit::RupeesCr, source_kind: SourceKind::Statement, column: "free_cashflow_last_year", needs_review: false },
    MetricSpec { id: MetricId::FreeCashflowTtm, label: "Free cash flow (TTM)", description: "Trailing 12 month statement FCF (CFO − capex), not Yahoo freeCashflow.", category: MetricCategory::CashFlow, unit: Unit::RupeesCr, source_kind: SourceKind::Statement, column: "free_cashflow_ttm", needs_review: false },
    MetricSpec { id: MetricId::FreeCashflow3ySum, label: "Free cash flow 3Y sum", description: "Sum of statement FCF (CFO − capex) over last 3 years.", category: MetricCategory::CashFlow, unit: Unit::RupeesCr, source_kind: SourceKind::Statement, column: "free_cashflow_3y_sum", needs_review: false },
    MetricSpec { id: MetricId::FreeCashflow5ySum, label: "Free cash flow 5Y sum", description: "Sum of statement FCF (CFO − capex) over last 5 years.", category: MetricCategory::CashFlow, unit: Unit::RupeesCr, source_kind: SourceKind::Statement, column: "free_cashflow_5y_sum", needs_review: false },
    ...
    MetricSpec { id: MetricId::CroicPct, label: "CROIC", description: "Cash return on invested capital: 3y avg statement FCF (CFO − capex) / (Net Worth + Total Debt - Cash).", category: MetricCategory::Composite, unit: Unit::Percent, source_kind: SourceKind::Composite, column: "croic_pct", needs_review: false },
